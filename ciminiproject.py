...
st.markdown("Enhance your low-light images using a deep learning model (Zero-DCE).")
...
if uploaded_file is not None:
    ...
    if not TFLITE_AVAILABLE:
        st.warning("Image enhancement is not available on this platform. Please run the app locally for full functionality.")
    else:
